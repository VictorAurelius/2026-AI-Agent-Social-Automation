...
**Spec Document:** `docs/superpowers/specs/2026-03-19-pdf-carousel-design.md`
...
**Files:**
- Create: `templates/carousel/cover.html`
- Create: `templates/carousel/content.html`
- Create: `templates/carousel/cta.html`
- Create: `templates/carousel/README.md`
...
**Files:**
- Create: `docker/init-db/04-carousel-prompt.sql`
...
**Files:**
- Update: `docs/huong-dan-workflows.md` (add WF9 section)
