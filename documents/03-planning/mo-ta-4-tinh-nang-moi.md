...
**Files:** `design-image-generation.md`, `quote-card.svg`, `infrastructure/templates/social-media/README.md`
...
File `infrastructure/templates/social-media/quote-card.svg` - template 1200x628 với:
...
**File:** `infrastructure/docker/init-db/03-facebook-prompts.sql`
...
|----|-----------|----------|----------|
| #7 | `documents/02-architecture/design-telegram-bot-interactive.md` | `workflows/n8n/telegram-bot.json` | - |
| #8 | `documents/02-architecture/design-image-generation.md` | - (Phase 2) | `infrastructure/templates/social-media/` |
| #9 | `documents/02-architecture/design-facebook-platforms.md` | - (dùng WF2 mở rộng) | `infrastructure/docker/init-db/03-facebook-prompts.sql` |
| #10 | `documents/02-architecture/design-auto-posting.md` | `facebook-post.json` + `linkedin-post-helper.json` | `infrastructure/docker/.env.example` |
